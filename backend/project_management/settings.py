...
SECRET_KEY = "django-insecure-z4js@w2^12+(=0!#np5+i&mw63r-4wnx6#44m#v)a)5_2rm9d#"
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=60),  # 2 месяца
    "REFRESH_TOKEN_LIFETIME": timedelta(days=90),  # Например, 3 месяца
