...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className={`sticky top-0 flex w-full items-center justify-between p-4 bg-white border-b border-gray-200 dark:bg-dark-bg dark:border-gray-800 transition-all duration-300 ease-in-out`}>      {/* Левый блок: Кнопка переключения боковой панели */}
      <button
