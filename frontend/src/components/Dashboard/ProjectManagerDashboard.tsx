...
const ProjectManagerDashboard: React.FC = () => {
  ...
  // Подсчет статистики по проектам куратора
  ...
  return (
    <div className="p-6 bg-gray-50">
      <h1 className="text-2xl font-bold mb-6">Дашборд куратора проекта</h1>
      ...
      <div className="flex justify-between gap-6 w-full">
        ...
        <div className="flex-1 max-w-full">
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <p className="text-base text-gray-600">Здесь можно добавить список проектов или другие данные.</p>
          </div>
        </div>
      </div>
    </div>
